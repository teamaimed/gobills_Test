...
const PricingIn = () => {
  ...
  return (
    ...
    <>
      <Head>
    <title>Pricing | Free GST Billing and Accounting Software | GoBills</title>
              ...
              <Col lg="9" xl="8">
                <div className="px-md-15 text-center mb-5 mb-lg-13">
                  ...
                  <p className="gr-text-8 mb-0">
                    GoBills comes with affordable pricing.  <b>
